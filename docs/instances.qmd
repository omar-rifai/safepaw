...
import pandas as pd
df= pd.read_csv("../data/open_data/summary_maternity_capacity.csv")
...
from IPython.display import display, Markdown
import pandas as pd
df = pd.read_csv("../data/open_data/summary_maternity_labours.csv", low_memory=False)
...
df_materinity = pd.read_csv("../data/open_data/summary_maternity_capacity.csv", low_memory=False)
df_labours = pd.read_csv("../data/open_data/summary_maternity_labours.csv", low_memory=False)
...
This demand is global for all patient groups. As we do not have detailed info on the demand per pation group,
 we multiplyby the obtained global demands by the statistics on delivery type  \[@DREES2021_naissance_accouchements\].
